#pragma once
#include "SingleYearThresholdCPUFunc.cpp"
#include "../DoubleYearThreshold/DoubleYearThresholdCPUFunc.cpp"
...
bool SingleYearThresholdFilter::compute_result(bool force_save){
    ...
    int num_threshold = __NUM_THRESHOLD_PER_CYCLE__*(index_length - 2);
    single_year_threshold_investing(
        temp_weight_storage, d_threshold, d_result, count_temp_storage, num_threshold,
        rows, config.num_cycle, config.interest, INDEX, PROFIT, index_length
    );
